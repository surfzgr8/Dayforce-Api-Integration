...
[assembly: FunctionsStartup(typeof(IVCE.DAI.Azure.Functions.Subscribers.Startup))]
...
namespace IVCE.DAI.Azure.Functions.Subscribers
{
    public class Startup : FunctionsStartup
    {
                  ...
                  options.Connect(settings["ConnectionStrings:AzureAppConfig"])
                          ...
                          .ConfigureRefresh(refresh =>
                          {
                              refresh.Register(".appconfig.featureflag/IBERIA_AAD_FEATURE", settings["DOTNET_ENVIRONMENT"], true)
                                    ...
                                    .Register(key:".appconfig.featureflag/ASSIGN_MANAGER_FEATURE", refreshAll: true)
                                    .SetCacheExpiration(TimeSpan.FromSeconds(1));
                          });
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddScoped<IADGraphServiceClientAdapter,ADGraphServiceClientAdapter>();
